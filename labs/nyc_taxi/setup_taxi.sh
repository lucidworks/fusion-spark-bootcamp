...
curl -X POST -H "Content-type:application/json" --data-binary '{
  "add-field": [
    ...
    { "name":"pickup_datetime", "type":"pdate", "stored":true, "indexed":true, "multiValued":false, "docValues":true },
    { "name":"dropoff_datetime", "type":"pdate", "stored":true, "indexed":true, "multiValued":false, "docValues":true },
    { "name":"trip_duration_secs", "type":"pint", "stored":true, "indexed":true, "multiValued":false, "docValues":true },
    ...
    { "name":"passenger_count", "type":"pint", "stored":true, "indexed":true, "multiValued":false, "docValues":true },
    { "name":"trip_distance", "type":"pdouble", "stored":true, "indexed":true, "multiValued":false, "docValues":true },
    { "name":"fare_amount", "type":"pdouble", "stored":true, "indexed":true, "multiValued":false, "docValues":true },
    { "name":"extra", "type":"pdouble", "stored":true, "indexed":true, "multiValued":false, "docValues":true },
    { "name":"mta_tax", "type":"pdouble", "stored":true, "indexed":true, "multiValued":false, "docValues":true },
    { "name":"tip_amount", "type":"pdouble", "stored":true, "indexed":true, "multiValued":false, "docValues":true },
    { "name":"tolls_amount", "type":"pdouble", "stored":true, "indexed":true, "multiValued":false, "docValues":true },
    { "name":"ehail_fee", "type":"pdouble", "stored":true, "indexed":true, "multiValued":false, "docValues":true },
    { "name":"improvement_surcharge", "type":"pdouble", "stored":true, "indexed":true, "multiValued":false, "docValues":true },
    { "name":"total_amount", "type":"pdouble", "stored":true, "indexed":true, "multiValued":false, "docValues":true },
